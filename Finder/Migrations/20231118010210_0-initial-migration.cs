...
{
    public partial class _0initialmigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InterestEmoji = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserRecieverId = table.Column<int>(type: "int", nullable: false),
                    IsAnswerPositive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Matches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Matches_Users_UserRecieverId",
                        column: x => x.UserRecieverId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Matches_Users_UserSenderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_UserRecieverId",
                table: "Matches",
                column: "UserRecieverId");

            migrationBuilder.CreateIndex(
                name: "IX_Matches_UserSenderId",
                table: "Matches",
                column: "UserSenderId");
